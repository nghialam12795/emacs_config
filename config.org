...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq mode-line-format
       '((:eval
         ...
         (format-mode-line
          (propertize (format-time-string "%H:%M %a %d/%m/%Y ") 'face `(:inherit face-popout)))))))
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;; This is just for a little fun
  (setq initial-scratch-message "\
   _________________________________________________________
  │ The best editor is the one you are most familiar with.  │
  | The best programmer is the one who always keep learning.|
  │ The best product is the one you created with love.      │
   ---------------------------------------------------------
     │
     └─┐
       │
